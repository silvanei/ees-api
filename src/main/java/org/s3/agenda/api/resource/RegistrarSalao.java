...
import org.s3.agenda.api.infrastructure.Conexao;
...
public class RegistrarSalao {
	...
	public Salao addSalao(Salao salao) throws JoseException {
		...
		try {
            ...
            Logger.getLogger(RegistrarSalao.class.getName()).log(Level.SEVERE, null, ex);
...
//	    
//	    System.out.println("PRIVATE: " +rsaJsonWebKey.getKey());
//
//	    try
//	    {
